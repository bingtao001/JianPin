...
一键为通讯录联系人添加拼音属性，解决 iPhone 通讯录排序错乱以及索引失效的问题。
...
1. 前往 [Releases](https://github.com/bingtao001/JianPin/releases) 页面下载最新版 `简拼通讯录.app`
...
```bash
git clone https://github.com/bingtao001/JianPin.git
cd JianPin
./build-app.sh
```
